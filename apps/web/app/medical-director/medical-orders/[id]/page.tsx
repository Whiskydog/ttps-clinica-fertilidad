...
export default function MedicalDirectorMedicalOrderDetailPage() {
  ...
  const handleDownloadPdf = (pdfUri: string) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {treatment && (
                <div className="md:col-span-2">
                  ...
                  <p className="mt-1">
                    <Link
                      href={`/medical-director/treatments/${treatment.id}`}
                      ...
                      <div className="flex gap-2">
                        ...
                        {result.originalPdfUri && (
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleDownloadPdf(result.originalPdfUri)
                            }
                          >
