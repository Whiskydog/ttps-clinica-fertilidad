...
import type { ApiResponse, TreatmentTimelineItem } from "@repo/contracts";

export type TreatmentTimelineResponse = ApiResponse<TreatmentTimelineItem[]>;
...
export async function getTreatmentTimeline(
  ...
  const resp = await fetch(`${backendUrl}/treatments/${treatmentId}/timeline`, {
    method: "GET",
    headers: {
