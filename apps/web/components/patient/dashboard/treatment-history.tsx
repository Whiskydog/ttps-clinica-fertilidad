      ...
      <CardContent>
        <div className="space-y-3">
          {treatments.map((treatment) => {
            const period = treatment.startDate && treatment.closureDate
              ...
              >
                <div>
                  ...
                  {treatment.initialObjective && (
                    <p className="text-sm">Tipo: {treatment.initialObjective}</p>
                  )}
                  {treatment.initialDoctor && (
                    <p className="text-sm">
                      Médico: Dr. {treatment.initialDoctor.firstName} {treatment.initialDoctor.lastName}
                    </p>
                  )}
