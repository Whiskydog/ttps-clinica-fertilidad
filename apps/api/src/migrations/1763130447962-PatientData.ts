...
export class PatientData1763130447962 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cryopreserved_products" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "product_id" character varying(100) NOT NULL, "product_type" character varying(20) NOT NULL, "status" character varying(50) NOT NULL, "cryopreservation_date" date NOT NULL, "location_tank" character varying(50), "location_rack" character varying(50), "location_tube" character varying(50), "location_position" character varying(50), "patient_id" integer NOT NULL, "treatment_id" integer NOT NULL, "quality" character varying(10), "fertilization_date" date, "pgt_result" character varying(50), "journey" jsonb, "maturation_state" character varying(50), "extraction_date" date, CONSTRAINT "UQ_730ecdf3c7b2cf3070d039401ad" UNIQUE ("product_id"), CONSTRAINT "PK_67191af61b93723056423849291" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cryopreserved_products" ADD CONSTRAINT "FK_8508955290d4d3bdff095271a84" FOREIGN KEY ("patient_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cryopreserved_products" ADD CONSTRAINT "FK_d7277ae46f75642a1a5ba093530" FOREIGN KEY ("treatment_id") REFERENCES "treatments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "cryopreserved_products" DROP CONSTRAINT "FK_d7277ae46f75642a1a5ba093530"`);
        await queryRunner.query(`ALTER TABLE "cryopreserved_products" DROP CONSTRAINT "FK_8508955290d4d3bdff095271a84"`);
        ...
        await queryRunner.query(`DROP TABLE "cryopreserved_products"`);
