...
export class BaseUsers1761331019501 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."biological_sex_enum" AS ENUM('male', 'female', 'intersex')`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_ace513fa30d485cfd25c11a9e4a" FOREIGN KEY ("role") REFERENCES "roles"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
